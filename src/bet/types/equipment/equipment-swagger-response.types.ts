...
} from '../equipment/equipment-response.types';
...
// Common Equipment Error Responses
...
// Common Delete and Restore Response Types
export class SwaggerEquipmentDeleteResponse {
  @ApiProperty({ description: 'Success message' })
  message: string;

  @ApiProperty({ description: 'ID of the deleted equipment' })
  id: number;
}
...
export class SwaggerEquipmentRestoreResponse {
  ...
  @ApiProperty({ description: 'ID of the restored equipment' })
  id: number;
}
